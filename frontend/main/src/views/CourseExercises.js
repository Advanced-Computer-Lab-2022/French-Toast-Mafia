...
const CourseExercises = () => { 
    ...
    const getQuestions = async () => {
        await axios.get(`http://localhost:5000/Subtitle/getExcercisesQuestions?id=${courseId}`).then(
            (res) => {
    ...
    const getAnswers = async () => {
        await axios.get(`http://localhost:5000/Subtitle/getExcercisesAnswers?id=${courseId}`).then(
            (res) => {
