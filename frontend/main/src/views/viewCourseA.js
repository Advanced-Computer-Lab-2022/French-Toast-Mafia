...
import CourseInfoA from "../components/dashboard/CourseInfoA";
    ...
    <div>
      ...
      <Row>  
        <Col sm="6" lg="6" xl="7" xxl="7">
          <CourseInfoA cId = {cId} course={course} instructor={instructor} ratingLength = {ratingLength} setReportAlert={setReportAlert}/>
        </Col>
